...
const ListComponent = ({ items }) => {
  ...
  const head = () => {
    ...
    const metaTitle =
      "Choose the correct meaning || Improve English Vocabulary";
    const metaDesc =
      "Improve your vocabulary with our interactive and engaging vocabulary tests. Select a test to get started!";
  ...
  const testCheck = () => {
    testGiveOrNot(
      { testCategory: "correct-meaning-intermediate", testNo: items * 6 - 5 },
    ...
    testGiveOrNot(
      { testCategory: "correct-meaning-intermediate", testNo: items * 6 - 4 },
    ...
    testGiveOrNot(
      { testCategory: "correct-meaning-intermediate", testNo: items * 6 - 3 },
    ...
    testGiveOrNot(
      { testCategory: "correct-meaning-intermediate", testNo: items * 6 - 1 },
    ...
    testGiveOrNot(
      { testCategory: "correct-meaning-intermediate", testNo: items * 6 - 0 },
      ...
      <div>
        ...
        >
          ...
          <Card className={`myCard text-center ${attempted6}`}>
            <Link
              href={`/category/correct-meaning/intermediate/test-${items * 6}`}
            >
              {attempted1 == "attemptedCard"
