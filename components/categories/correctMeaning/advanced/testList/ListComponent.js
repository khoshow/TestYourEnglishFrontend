...
const ListComponent = ({ items }) => {
  ...
  const testCheck = () => {
    testGiveOrNot(
      { testCategory: "correct-meaning-advanced", testNo: items * 6 - 5 },
    ...
    testGiveOrNot(
      { testCategory: "correct-meaning-advanced", testNo: items * 6 - 4 },
    ...
    testGiveOrNot(
      { testCategory: "correct-meaning-advanced", testNo: items * 6 - 3 },
    ...
    testGiveOrNot(
      { testCategory: "correct-meaning-advanced", testNo: items * 6 - 2 },
    ...
    testGiveOrNot(
      { testCategory: "correct-meaning-advanced", testNo: items * 6 - 1 },
    ...
    testGiveOrNot(
      { testCategory: "correct-meaning-advanced", testNo: items * 6 - 0 },
