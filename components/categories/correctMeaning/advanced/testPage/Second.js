...
import { postScore } from "../../../../../actions/categories/correct-meaning/advanced";
...
function Second2(pageData, next) {
  ...
  const handlePreviousTest = () => {
    // Set the new URL
    const newUrl = `/category/correct-meaning/advanced/test-${testNo - 1}`; // Replace this with your desired URL
        ...
        <div>
          ...
          <Card className="myCard text-center scoreCard ">
            ...
            <div className="d-flex">
              <Link
                href={`/category/correct-meaning/advanced/test-${testNo - 1}`}
                onClick={(e) => {
                  handleNextTest(e);
                }}
