...
import { postScore } from "../../../../../actions/correct-word/advanced";
...
function Second2(pageData, next) {
  ...
  const handlePreviousTest = () => {
    // Set the new URL
    const newUrl = `/vocabulary/correct-word/advanced/test-${testNo - 1}`; // Replace this with your desired URL
    ...
    <div className="quizContainer">
      {showScore ? (
        <div className="scoreSection">
          ...
          <Link
            href={`/vocabulary/correct-word/advanced/test-${testNo + 1}`}
            onClick={(e) => {
              handleNextTest(e);
            }}
