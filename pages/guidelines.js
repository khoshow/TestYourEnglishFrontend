...
export default function Rules() {
  const head = () => (
    <Head>
      <title>Test My English Online || Rules</title>
      <meta name="title" content="Rules and usage of Test My English Online" />
      <meta
        name="description"
        content="Rules for scores, ranking, tests and other guidelines of Test My English Online"
      />
            ...
            <div className="row align-items-center">
              <div className="col-xl-9 m-auto">
                <div className="lg-pb-50 mobileViewTopMargin">
                  ...
                  <ol>
                    <li>
                      Thank you for being here. Our aim is to make your English
                    ...
                    <li>
                      Each category is further divided into Intermediate and
                      Advanced levels.
                    </li>
                    <li>
                    ...
                    <li>
                      ...
                      promoting fairness and transparency in the assessment of
