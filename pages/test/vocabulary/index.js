...
const Test = (props) => {
  ...
  const [pageInfo, setPageInfo] = useState([
    { url: currentUrl + "/choose-correct-word", title: "Correct Word", image:"/images/icon/choose.png" },
    { url: currentUrl + "/synonyms", title: "Synonyms", image:"/images/icon/synonyms.png" },
  ]);
  const pageData = () => {
    return {
      path: currentUrl,
